...
let siteData = {
  ...
  policies: {
    privacy: {
      ...
      intro: "نحن في شركة Karmel+ نلتزم بحماية خصوصية زوارنا وعملائنا الكرام. تشرح هذه السياسة الشاملة كيفية جمع واستخدام وحماية المعلومات الشخصية التي تقدمها لنا.",
    ...
    terms: {
      ...
      law: "تخضع هذه الشروط للقوانين المحلية المعمول بها ويتم حل النزاعات من خلال:\n• المحادثات الودية والتفاوض المباشر\n• الوساطة من قبل طرف محايد\n• المحاكم المختصة المحلية"
    }
  }
};
